      ...
      <div className="flex flex-col items-center mx-auto max-w-3xl space-y-10 py-8 px-2">
        ...
        <section className="w-full rounded-[2.5rem] border border-neutral-100 bg-white p-10 sm:p-14 shadow-premium">
          ...
          <div className="mt-10 overflow-hidden rounded-[2rem] border-2 border-neutral-100 bg-neutral-50 p-8 shadow-inner group">
            ...
            <div className="text-5xl font-black tracking-tighter text-neutral-900 tabular-nums bg-white inline-block px-8 py-4 rounded-3xl shadow-sm border border-neutral-100 group-hover:border-neutral-900 transition-colors">
        ...
        {whatsappLink ? (
          <section className="w-full rounded-[2.5rem] border border-emerald-100 bg-emerald-50/50 p-10 sm:p-14 shadow-sm">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-10 inline-flex justify-center items-center gap-4 rounded-full bg-[#25D366] px-12 py-6 text-sm font-black uppercase tracking-widest text-white transition-all hover:bg-[#20bd5a] hover:shadow-2xl hover:shadow-[#25D366]/30 active:scale-[0.98] w-full sm:w-auto"
            >
